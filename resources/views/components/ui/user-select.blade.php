...
>
    ...
    >
        ...
        >
            ...
            <div
                class="custom-scrollbar max-h-60 overflow-y-auto"
            >
                <template
                ...
                >
                    ...
                    >
                        <span
                            class="material-symbols-outlined mb-2 block text-3xl font-light"
                        >{{ $emptyIcon }}</span>
                        {{ $emptyText }}
                    </div>
                </template>
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <template
                                x-if="Number(selectedId) === Number(user.id)"
                            >
                                <span
